/datum/socialrole/shop/magadonpharmacist
	uniforms = list(/obj/item/clothing/under/vampire/magadon_shirt)
	shoes = list(/obj/item/clothing/shoes/vampire/businessblack)
