GLOBAL_DATUM_INIT(fire_overlay, /mutable_appearance, mutable_appearance('modular_darkpack/master_files/icons/effects/fire.dmi', "fire", appearance_flags = RESET_COLOR|KEEP_APART)) // DARKPACK EDIT CHANGE
